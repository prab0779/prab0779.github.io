    ...
    <div className="relative">
      ...
      <div className="relative z-10">
        <section className="relative overflow-hidden w-full pt-[200px] md:pt-[500px] pb-[140px] md:pb-[200px]">
          <div className="absolute -top-40 -bottom-40 left-1/2 -translate-x-1/2 w-screen z-0 opacity-40 pointer-events-none mask-image-[linear-gradient(to_bottom,black,black,transparent)]">
            <ShapeGrid
              speed={0.5}
              squareSize={40}
              direction="diagonal"
